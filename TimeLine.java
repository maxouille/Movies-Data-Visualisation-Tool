...
public class TimeLine {
	...
	public void drawTimeLine () {
		p.line((float) beginPosition.getX(), (float) beginPosition.getY(), (float) endPosition.getX(), (float) endPosition.getY());
		p.textSize(20);
		p.textAlign(p.CENTER);
		p.fill(0,102,153);
		p.text(beginDate+"", (float) beginPosition.getX(), (float) beginPosition.getY()-15);
		p.text(endDate+"", (float) endPosition.getX(), (float) endPosition.getY()-15);
		p.text(currentDate+"", (float) currentPosition.getX(), (float) currentPosition.getY()-15);
		p.ellipse((float) currentPosition.getX(), (float) currentPosition.getY(), 20, 20);
	}
